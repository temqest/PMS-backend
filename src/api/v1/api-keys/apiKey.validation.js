...
const createApiKeySchema = Joi.object({
  ...
  permissions: Joi.array()
    .optional()
    .items(Joi.string().valid('read:invoices', 'read:patients', 'read:health-records', 'read:appointments', 'write:invoices'))
    .default(['read:invoices'])
    .messages({
      'array.includes': 'Invalid permission. Allowed: read:invoices, read:patients, read:health-records, read:appointments, write:invoices',
    }),
});
